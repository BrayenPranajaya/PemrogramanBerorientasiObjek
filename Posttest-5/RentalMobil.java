...
abstract class Mobil {
    ...
    public void setHargaSewa(String harga) {
        this.hargaSewa = Double.parseDouble(harga);
    }

    public abstract void tampilFiturKhusus(); // ✅ abstract method
...
class MobilMewah extends Mobil {
    ...
    @Override
    public void tampilFiturKhusus() {
        System.out.println("Fitur: WiFi = " + (adaWiFi ? "Ya" : "Tidak") + ", TV = " + (adaTV ? "Ya" : "Tidak"));
    }
}

// ✅ final class
final class MobilEkonomi extends Mobil {
    ...
    @Override
    public void tampilFiturKhusus() {
        System.out.println("Konsumsi BBM: " + konsumsiBBM + " L/km");
    }
}
