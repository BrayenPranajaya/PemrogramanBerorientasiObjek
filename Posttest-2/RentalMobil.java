...
class Mobil {
    ...
    // Getter & Setter untuk Harga Sewa
...
public class RentalMobil {
    ...
    public static void perbaruiMobil() {
        ...
        Mobil mobilDitemukan = null;
        for (Mobil mobil : daftarMobil) {
            if (mobil.getId() == id) {
                mobilDitemukan = mobil;
                break;
            }
        }
        ...
        mobilDitemukan.setNama(scanner.nextLine());
        System.out.print("Masukkan deskripsi baru: ");
        mobilDitemukan.setDeskripsi(scanner.nextLine());
        System.out.print("Masukkan harga sewa baru: ");
        mobilDitemukan.setHargaSewa(scanner.nextDouble());
        scanner.nextLine();
    ...
    public static void hapusMobil() {
        ...
        daftarMobil.removeIf(mobil -> mobil.getId() == id);
